    ...
    return """
          ...
          @media (max-width: 768px) {
            ...
            .mobile-nav-panel {
              ...
              padding: 12px;
              border-radius: 16px;
              border: 1px solid rgba(92, 112, 150, 0.28);
...
def build_public_content_surface_css() -> str:
    return """
          ...
          .content-page .tool-shell,
          .content-page .result-preview-card,
          .content-page .example-card,
          .landing-page .section-stack,
          .landing-page .content-section,
          .landing-page .seo-section,
          .landing-page .flat-section,
          .landing-page .plain-section,
          .landing-page .result-preview-card,
          .landing-page .example-card,
          .seo-page .section-stack,
          .seo-page .content-section,
          .seo-page .seo-section,
          .seo-page .flat-section,
          .seo-page .plain-section,
          .seo-page .result-preview-card,
          .seo-page .example-card {
            color: #DCE6FF !important;
          }

          .content-page .section-stack h1,
          .content-page .section-stack h2,
          .content-page .section-stack h3,
          ...
          .content-page .result-preview-title,
          .content-page .result-preview-card h1,
          .content-page .result-preview-card h2,
          .content-page .result-preview-card h3,
          .content-page .example-card h1,
          .content-page .example-card h2,
          .content-page .example-card h3,
          .landing-page .section-stack h1,
          .landing-page .section-stack h2,
          .landing-page .section-stack h3,
          ...
          .landing-page .result-preview-title,
          .landing-page .result-preview-card h1,
          .landing-page .result-preview-card h2,
          .landing-page .result-preview-card h3,
          .landing-page .example-card h1,
          .landing-page .example-card h2,
          .landing-page .example-card h3,
          .seo-page .section-stack h1,
          .seo-page .section-stack h2,
          .seo-page .section-stack h3,
          ...
          .seo-page .result-preview-title,
          .seo-page .result-preview-card h1,
          .seo-page .result-preview-card h2,
          .seo-page .result-preview-card h3,
          .seo-page .example-card h1,
          .seo-page .example-card h2,
          .seo-page .example-card h3 {
            color: #F4F7FF !important;
            opacity: 1 !important;
          }

          .content-page .section-stack p,
          .content-page .section-stack li,
          ...
          .content-page .result-preview-card p,
          .content-page .result-preview-card li,
          .content-page .result-preview-list,
          .content-page .example-card p,
          .content-page .example-card li,
          .landing-page .section-stack p,
          .landing-page .section-stack li,
          .landing-page .content-section p,
          .landing-page .content-section li,
          .landing-page .seo-section p,
          .landing-page .seo-section li,
          .landing-page .result-preview-card p,
          .landing-page .result-preview-card li,
          .landing-page .result-preview-list,
          .landing-page .example-card p,
          .landing-page .example-card li,
          .seo-page .section-stack p,
          .seo-page .section-stack li,
          .seo-page .content-section p,
          .seo-page .content-section li,
          .seo-page .seo-section p,
          .seo-page .seo-section li,
          .seo-page .result-preview-card p,
          .seo-page .result-preview-card li,
          .seo-page .result-preview-list,
          .seo-page .example-card p,
          .seo-page .example-card li {
            color: #C7D4F1 !important;
            opacity: 1 !important;
          }

          .content-page .helper,
          .content-page .small,
          .content-page .result-preview-label,
          .content-page .result-preview-score,
          .content-page .conversion-trust-row,
          .content-page .example-card .helper,
          .landing-page .helper,
          .landing-page .small,
          .landing-page .result-preview-label,
          .landing-page .result-preview-score,
          .landing-page .conversion-trust-row,
          .seo-page .helper,
          .seo-page .small,
          .seo-page .result-preview-label,
          .seo-page .result-preview-score,
          .seo-page .conversion-trust-row {
            color: #B7C6E6 !important;
            opacity: 1 !important;
          }

          .content-page .summary-box p,
          .content-page .summary-box li,
          .content-page .hero-panel p,
          .content-page .hero-panel li,
          .content-page .trust-box p,
          .content-page .trust-box li,
          ...
          .content-page .summary-box h1,
          .content-page .summary-box h2,
          .content-page .summary-box h3,
          .content-page .hero-panel h1,
          .content-page .hero-panel h2,
          .content-page .hero-panel h3,
          .content-page .trust-box h1,
    ...
    <header id="siteHeader" class="site-header">
      <div class="site-header-inner">
        ...
        <div class="site-header-account-row">
          <button id="mobileMenuToggle" class="mobile-menu-toggle" type="button" aria-expanded="false" aria-controls="mobileNavPanel">Menu</button>
    ...
    <script>
      (function() {{
        ...
        document.addEventListener("click", function(event) {{
          if (!event.target.closest("#mobileMenuToggle") && !event.target.closest("#mobileNavPanel")) {{
            setMobileMenu(false);
          }}
        }});
